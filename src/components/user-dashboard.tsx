...
import { CheckCircle2, ArrowRight, GraduationCap, ChevronRight, ClipboardList, PieChart as PieChartIcon, User } from "lucide-react";
...
function UserDashboard({ onNavigate }: { onNavigate: (view: View) => void }) {
  const { user } = useAuth();
