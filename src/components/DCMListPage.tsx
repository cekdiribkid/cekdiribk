...
import {
  ArrowLeft, ArrowRight, CheckCircle2, GraduationCap, ClipboardList,
} from "lucide-react";
...
export default function DCMListPage({ onNavigate, onSelectSurvey }: { onNavigate: (view: View) => void; onSelectSurvey: (id: string) => void }) {
  const { user } = useAuth();
